...
#
#     PHX_SERVER=true bin/creepy_crawlie_cinema_club start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :creepy_crawlie_cinema_club, CreepyCrawlieCinemaClubWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  config :creepy_crawlie_cinema_club, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
